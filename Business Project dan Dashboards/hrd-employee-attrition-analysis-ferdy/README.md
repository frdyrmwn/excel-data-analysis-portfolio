...
1. Data Mentah: Stores the original raw extraction of employee records containing education levels, joining years, cities, payment tiers, ages, genders, benched statuses, domain experiences, and attrition statuses.
2. Case: Defines the analytical framework, business background, specific case questions, and expected business outputs for the portfolio project.
3. Referensi Vlookup: Houses the master reference lookup table that defines the tier categories and salary range statuses based on numeric payment tiers.
4. Data Preparation: Performs data transformation, cleaning, and calculated field enrichments by deploying the VLOOKUP formula to dynamically pull descriptive tier categories and salary statuses into the main data structure.
5. Pivot: Houses multi-dimensional Pivot Tables that aggregate employee distribution and attrition rates across education backgrounds, compensation tiers, benched statuses, and domain experience lengths.
6. Dashboard: The core executive presentation sheet integrating dynamic Pivot Charts, interactive Slicers, and analytical text boxes featuring justified executive summaries for final conclusions.

RESEARCH QUESTIONS ADDRESSED
1. How is the employee attrition rate distributed across education levels, cities, and genders?
2. How significantly do payment tiers integrated via VLOOKUP and years of experience impact employee loyalty and turnover?
3. Do employees who frequently experience benched statuses exhibit a higher probability of resignation?
4. Which demographic and professional variable combinations exhibit the highest turnover risk probability?

DETAILED PROCESS: DATA PREPARATION, FORMULAS & VLOOKUP INTEGRATION
